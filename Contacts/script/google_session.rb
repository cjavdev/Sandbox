...
configure do
  ...
  client.authorization.scope = 'https://www.googleapis.com/contacts'


  calendar =  client.discovered_api('contacts', 'v3')
  puts calendar.methods.sort
  # puts client.resolve_uri('https://www.google.com/m8/feeds/contacts/default/full')
  #calendar = client.discovered_api('contacts', 'v3')
